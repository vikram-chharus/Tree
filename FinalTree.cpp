...
void showIndex()
{
	...
	cout<<"2. to Modify a node "<<endl;
	cout<<"3. to Delete a node "<<endl;
	cout<<"4. Search for node "<<endl;
	cout<<"5. Pre-Order Sequence or DFS"<<endl;
	cout<<"6. In-Order Sequence " <<endl;
	cout<<"7. Post-Order Sequence"<<endl;
	cout<<"8. Level-Order or BFS Sequence"<<endl;
	cout<<"0. Exit  : ";
}
int main()
{
	...
	while( again )
	{
		switch(input)
		{
			case 1:
				if( isFirstNode )
				{
					cout<<endl<<"\t\tEnter value for Root Node : ";
					cin>>input;
					root = new Node(input);
				...
				{
					cout<<endl<<"\t\tEnter value for child Node : ";
					cin>>input;
					root->addNode(input);
				}
				break;
			case 2:
				...
				cout<<endl<<"\t\tEnter old value of the node to modify : ";
				cin>>oldValue;
				cout<<"\t\tEnter new Value : ";
				cin>>newValue;
				if( !root->replace(oldValue,newValue) )
				{
				...
				break;
			case 3:
				cout<<endl<<"\t\tEnter node value to delete the node : ";
				cin>>input;
				if( root->removeNode(input,root) )
				{
					cout<<"Node deleted successfully.."<<endl;
				}
				else
				{
					cout<<"Removing failed!!!"<<endl;
				}
				break;
			case 4:
				cout<<"Enter value to search the node : ";
				cin>>input;
				if( root->contain(input) )
				{
			...
			case 8:
				v = root->levelOrder();
				cout<<endl<<"\t\tLevel-Order sequence : ";
				while ( v->size() > 0 )
				{
					cout<<*v->begin()<<" ";
					v->erase(v->begin());
